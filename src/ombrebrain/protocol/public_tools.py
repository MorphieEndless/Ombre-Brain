...
class PublicToolDesignContract:
    ...
    def default(cls) -> "PublicToolDesignContract":
        return cls(
            normal_tools=frozenset({"hold", "grow", "source_read", "source_attach", "source_detach", "source_restore", "trace", "breath", "breath_search", "breath_advanced", "pulse", "dream", "anchor", "i", "letter", "plan"}),
